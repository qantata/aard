...
(() => {
  ...
  const gentimeSettings = {
    ...
    "prismaClientImportId": "/snapshot/aard/apps/server/prisma/generated"
  }
  ...
  const dmmf = getPrismaClientDmmf({
    ...
    require: () => require("/snapshot/aard/apps/server/prisma/generated"),
    importId: gentimeSettings.prismaClientImportId,
    importIdResolved: require.resolve("/snapshot/aard/apps/server/prisma/generated")
  })
